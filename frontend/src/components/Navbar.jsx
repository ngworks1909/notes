...
const Navbar = () => {
  ...
  return (
        ...
        <div className="app-logo">
            <Link to="/"><h1 className='app-logo-text'>Notes</h1></Link>
        </div>
        <div className="menu-list display-flex align-center">
           <div className='display-flex align-center justify-center menu-icon-button'><HiDotsVertical className='menu-icon cursor-pointer'/>
